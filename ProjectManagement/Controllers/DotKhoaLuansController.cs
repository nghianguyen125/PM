...
{
    public class DotKhoaLuansController : Controller
    {
        ...
        {
            var dotKhoaLuans = db.DotKhoaLuans.Include(d => d.NamHoc).Include(d => d.QuanLyLich).Include(d => d.PhanDeTaiChoDotKhoaLuans);
            return View(dotKhoaLuans.ToList());
        }

        // GET: DotKhoaLuans/Details/5
        ...
        // GET: DotKhoaLuans/Create
        public ActionResult Create()
        {
            ViewBag.NamHocHocKyId = new SelectList(db.NamHocs, "NamHocHocKyId", "TenNamHocHocKy");
            ViewBag.DotKhoaLuanId = new SelectList(db.QuanLyLiches, "DotKhoaLuanId", "NoiDung");
            return View();
        }

        // POST: DotKhoaLuans/Create
        ...
        public ActionResult Create([Bind(Include = "DotKhoaLuanId,TenDotKhoaLuan,NamHocHocKyId")] DotKhoaLuan dotKhoaLuan)
        {
            ...
            ViewBag.DotKhoaLuanId = new SelectList(db.QuanLyLiches, "DotKhoaLuanId", "NoiDung", dotKhoaLuan.DotKhoaLuanId);
            return View(dotKhoaLuan);
        }

        // GET: DotKhoaLuans/Edit/5

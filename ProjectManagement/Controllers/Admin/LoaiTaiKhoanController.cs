...
namespace ProjectManagement.Controllers.Admin
{
    public class LoaiTaiKhoanController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LoaiTaiKhoanId,Loai")] LoaiTaiKhoan loaiTaiKhoan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoaiTaiKhoanId,Loai")] LoaiTaiKhoan loaiTaiKhoan)
        {
            if (ModelState.IsValid)
            {

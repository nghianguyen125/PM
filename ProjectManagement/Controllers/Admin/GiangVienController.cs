...
namespace ProjectManagement.Controllers.Admin
{
    public class GiangVienController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GiangVienId,GioiTinh,HoTen")] GiangVien giangVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GiangVienId,GioiTinh,HoTen")] GiangVien giangVien)
        {
            if (ModelState.IsValid)
            {

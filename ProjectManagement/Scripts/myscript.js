$(document).ready(function () {
    ...
    slide_2();
    slideshow();
	$('.col_gostock_1 .show_stock').first().addClass('show');
	$('.num_stock_1').addClass('show');
	$('.pagi_ul_stock li:nth-child(1) i').addClass('active');
	showbizActive();
...
function show_stock(num) {
	...
	$('.pagi_ul_stock li i').removeClass('active');
	$('.pagi_ul_stock li:nth-child('+num+') i').addClass('active');
}
